...
/*var Botkit = require('botkit'),
    mongoStorage = require('botkit-storage-mongo')({mongoUri: 'mongodb://admin:admin@ds143211.mlab.com:43211/heroku_s9lgknlf', tables: ['appointments','companies', 'submittedforms']}),
    controller = Botkit.slackbot({
        storage: mongoStorage
    });*/

/*var beans = {id: 'cool', beans: ['appointments']};
controller.storage.appointments.save(beans);
controller.storage.appointments.get('cool', function(error, beans){
...
mongoose.connect('mongodb://admin:admin@ds143211.mlab.com:43211/heroku_s9lgknlf');
...
var mongoStorage = require('botkit-storage-mongo')({mongoUri: 'mongodb://admin:admin@ds143211.mlab.com:43211/heroku_s9lgknlf', tables: ['appointments','companies', 'submittedforms']});
